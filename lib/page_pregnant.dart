...
class _PregnantPageState extends State<PregnantPage> {
  ...
  // Estimate tab width: padding(12*2) + icon(15) + spacing(6) + text(~90) + margin(8) ≈ 143px
  static const double _kTabWidth = 143.0;
  ...
  void _selectSubTab(int i) {
    setState(() => _selectedSubTab = i);
